...
tasks: list[TaskCreate] = [
    ...
    TaskCreate(name="task_6", deadline=date(2024, 1, 1), status="in progress",      parent_id=None, worker_id=3),
    ...
    TaskCreate(name="task_10", deadline=date(2024, 1, 1), status="in progress",     parent_id=11,   worker_id=2),
    ...
    TaskCreate(name="task_13", deadline=date(2024, 1, 1), status="not in progress", parent_id=None, worker_id=2),
    TaskCreate(name="task_14", deadline=date(2024, 1, 1), status="not in progress", parent_id=None, worker_id=None),
    TaskCreate(name="task_15", deadline=date(2024, 1, 1), status="not in progress", parent_id=None, worker_id=None),
    TaskCreate(name="task_16", deadline=date(2024, 1, 1), status="not in progress", parent_id=None, worker_id=None),
    ...
    TaskCreate(name="task_19", deadline=date(2024, 1, 1), status="not in progress", parent_id=None, worker_id=None),
    TaskCreate(name="task_20", deadline=date(2024, 1, 1), status="not in progress", parent_id=None, worker_id=None),
    ...
    TaskCreate(name="task_27", deadline=date(2024, 1, 1), status="in progress",     parent_id=None, worker_id=4),
